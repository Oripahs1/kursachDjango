...
class Order(models.Model):
    ...
    consignment = models.FileField(null=True, upload_to='consignment/', blank=True)
    received_ptd = models.FileField(null=True, upload_to='received_ptd/', blank=True)
    invoice = models.FileField(null=True, upload_to='invoice/', blank=True)
    payment_order = models.FileField(null=True, upload_to='payment_order/', blank=True)
